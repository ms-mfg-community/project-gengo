...
New-Item -ItemType Directory -Path "calculator-xunit-testing"
...
dotnet new console -n calculator --framework net8.0 --no-restore
...
dotnet new xunit -n calculator.tests --framework net8.0 --no-restore
