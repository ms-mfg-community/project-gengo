// Calculator test runner (CommonJS version)

// Directly define the calculator functions to avoid module import issues
const add = (a, b) => a + b;
...
const modulo = (a, b) => {
  if (b === 0) throw new Error("Cannot find modulo with zero");
  return a % b;
};
