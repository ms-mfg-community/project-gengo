...
#### Prompt 3: "Create a query that groups demos by category and language showing the count and average confidence"
...
#### Prompt 2: "Update the demo ID 5 to use the following values; confidence_percent = 70, notes = 'update notes for id 5' and points = 20"
