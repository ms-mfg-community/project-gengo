...
6. Use the --api-version as a github actions env: variable to specify the current Bicep API version for all az deployment or what-if commands, e.g., `--api-version ${{ env.api-version }}`.
